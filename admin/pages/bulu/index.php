                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="text-sm-end">
                            <a href="admin/admin.php?halaman=tambah-tpibulu" class="btn btn-success btn-rounded" id="addProject-btn">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        <a href="admin/admin.php?halaman=update-tpibulu&id=<?php echo $id_tpi; ?>" class="btn btn-warning">
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'admin/admin.php?halaman=hapus-tpibulu&id=' + id;
            }
        });
    }
    ...
    function filterByMonthYear() {
        ...
        window.location.href = 'admin/admin.php?halaman=tpi-bulu&month=' + month + '&year=' + year;
    }
</script>