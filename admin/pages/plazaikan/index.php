                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="text-sm-end">
                            <a href="admin/admin.php?halaman=tambah-tpiplazaikan" class="btn btn-success btn-rounded" id="addProject-btn">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        <a href="admin/admin.php?halaman=update-tpiplazaikan&id=<?php echo $id_tpi; ?>" class="btn btn-warning">
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'admin/admin.php?halaman=hapus-tpiplazaikan&id=' + id;
            }
        });
    }
    ...
    function filterByMonthYear() {
        ...
        window.location.href = 'admin/admin.php?halaman=tpi-plazaikan&month=' + month + '&year=' + year;
    }
</script>