...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $id_admin = intval($_GET['id']); // Ensure the ID is treated as an integer

    // Prepare delete query
    if ($delete_query = $koneksi->prepare("DELETE FROM tb_admin WHERE id_admin = ?")) {
            ...
            if ($delete_query->affected_rows > 0) {
                ...
                <script>
                    Swal.fire({
                        ...
                        window.location.href = 'admin/admin.php?halaman=user';
                    });
                </script>";
            } else {
                echo "
