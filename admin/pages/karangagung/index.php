...
$nama_tpi_filter = "TPI KARANGAGUNG";
$stmt_daily->execute();
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="text-sm-end">
                            <a href="admin/admin.php?halaman=tambah-tpikarangagung" class="btn btn-success btn-rounded" id="addProject-btn">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        <a href="admin/admin.php?halaman=update-tpikarangagung&id=<?php echo $id_tpi; ?>" class="btn btn-warning">
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'admin/admin.php?halaman=hapus-tpikarangagung&id=' + id;
            }
        });
    }
    ...
    function filterByMonthYear() {
        ...
        window.location.href = 'admin/admin.php?halaman=tpi-karangagung&month=' + month + '&year=' + year;
    }
</script>