...
function saveTpiData($koneksi)
{
    if (isset($_POST['save'])) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                showAlert('Data berhasil disimpan!', 'plaza.php');
            } else {
...
function updateTpiData($koneksi)
{
    if (isset($_POST['update'])) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                showAlert('Data berhasil diperbarui!', 'plaza.php');
            } else {
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4>Tambah Data Perolehan Ikan TPI PLAZA IKAN</h4>
                                    <form method="post">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-sm-0 font-size-18">Data Perolehan Ikan TPI PLAZA IKAN</h4>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="tpiTable">
                                            ...
                                            <tbody>
                                                ...
                                                $query = "SELECT * FROM tb_tpi WHERE tanggal = ? AND nama_tpi = 'TPI PLAZA IKAN'";
                                                $stmt = $koneksi->prepare($query);
