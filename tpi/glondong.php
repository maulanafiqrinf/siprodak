...
function saveTpiData($koneksi)
{
    if (isset($_POST['save'])) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                showAlert('Data berhasil disimpan!', 'glondong.php');
            } else {
...
function updateTpiData($koneksi)
{
    if (isset($_POST['update'])) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                showAlert('Data berhasil diperbarui!', 'glondong.php');
            } else {
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4>Tambah Data Perolehan Ikan TPI GLONDONG GEDE</h4>
                                    <form method="post">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="nama_tpi" name="nama_tpi" class="form-control" required>
                                                        <option value="TPI GLONDONG GEDE" selected>TPI GLONDONG GEDE</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-sm-0 font-size-18">Data Perolehan Ikan TPI GLONDONG GEDE</h4>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="tpiTable">
                                            ...
                                            <tbody>
                                                ...
                                                $query = "SELECT * FROM tb_tpi WHERE tanggal = ? AND nama_tpi = 'TPI GLONDONG GEDE'";
                                                $stmt = $koneksi->prepare($query);
